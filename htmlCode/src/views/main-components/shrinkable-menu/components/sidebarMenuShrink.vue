    ...
    <div>
        <template v-for="(item, index) in menuList">
            <div style="text-align: center;" :key="index">
                <Dropdown transfer v-if="item.children.length >= 1 && item.children[0].name.indexOf('_index') >= 0" placement="right-start" :key="index" @on-click="changeMenu">
                    <Button @click="changeMenu(item.children[0].name)" style="width: 60px; padding:10px 0;" type="text">
                ...
                <Dropdown transfer v-else placement="right-start" :key="index" @on-click="changeMenu">
                    <Button style="width: 60px; padding:10px 0;" type="text">
